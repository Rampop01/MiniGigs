import { MINIGIGS_ADDRESS } from 'minigigs-sdk';
...
export const MOCK_GIGS: Gig[] = [
  {
    ...
    description:
      'Translate 40 UI strings for a mobile fintech app from English to Swahili. Must be a native speaker. Deliver as a JSON file.',
  ...
  },
  {
    ...
    description:
      'Visit your nearest open-air market and photograph price tags for 10 staple goods (maize, rice, cooking oil, etc). GPS metadata required.',
    category: 'data',
    bounty: 15,
    timeEstimate: '1 hr',
    verification: 'worldid',
  ...
  },
  {
    ...
    description:
      'Follow a guided test script (15 steps) for a new send-money flow in a staging MiniPay build. Report any bugs found with screenshots.',
    category: 'testing',
    bounty: 5,
    timeEstimate: '15 min',
    verification: 'none',
  ...
  },
  {
    ...
    description:
      'Write a 200-word honest review of the Valora wallet experience. Must include at least one screenshot of your own usage.',
    category: 'content',
    bounty: 3,
    timeEstimate: '15 min',
    verification: 'self',
  ...
  },
  {
    ...
    description:
      'Review the onboarding flow (5 screens) of a DeFi lending app. Provide 3 actionable improvements with annotated screenshots.',
    category: 'design',
    bounty: 20,
    timeEstimate: '2 hr',
    verification: 'worldid',
  ...
  },
  {
    ...
    description:
      'Transcribe a 3-minute Yoruba voice recording into typed text. Basic punctuation required.',
    category: 'data',
    bounty: 4,
    timeEstimate: '10 min',
    verification: 'none',
