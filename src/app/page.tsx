            ...
            <main className={styles.main}>
                ...
                <section className={styles.features}>
                    <div className={styles.sectionHeader}>
                        <h2 className={styles.sectionTitle}>Built for the <br />Global South</h2>
                        <p className={styles.sectionSubtitle}>MiniGigs is optimized for low-bandwidth, mobile-first micro-work.</p>
                    </div>
                    ...
                    <div className={styles.grid}>
                        <div className={styles.featureCard}>
                            ...
                            <h3>Instant cUSD</h3>
                            <p>Get paid the moment your work is approved. No waiting days for bank transfers.</p>
                        </div>
